MLP_Audio_retrieval.ipynb : The MLP based audio retieval module. Useful to find the evaluation metrics.

mir-project.ipynb: Real time audio retieval. it provide an interactive user interface to give the search queries.
